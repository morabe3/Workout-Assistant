 ...
 <div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" style="margin-left: 130px;">
    <div class="carousel-item active">
      <img src="..\images\q.jpg" alt="var" width="1000" height="500">
    </div>
    <div class="carousel-item">
      <img src="..\images\quote2.jpg" alt="match" width="1000" height="500">
    </div>
    <div class="carousel-item">
      <img src="..\images\quote3.jpg" alt="coal" width="1000" height="500">
    </div>
  </div>
...
<br><br>
<input type="submit" value="View All Workouts" name="submit3" id="button">
<br><br>
<input type="submit" value="Search For User" name="submit1" id="button">
<br><br>  
